...
Return ONLY valid JSON:
{
    ...
    const response = await anthropic.messages.create({
      ...
      messages: [{
        role: 'user',
        content: `Research this property owner. You MUST run these exact searches in order:

SEARCH 1: "${streetAddress} ${city} zillow"
SEARCH 2: "${ownerName} ${city} ${state}"  
SEARCH 3: "${ownerName} linkedin"
SEARCH 4: "${streetAddress} ${city} redfin"

Owner: ${ownerName}
Address: ${propertyAddress}

Run all 4 searches before generating your response. Report what you find from each search.`
      }]
    });
