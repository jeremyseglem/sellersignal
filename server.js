...
Return ONLY valid JSON:
{
  ...
  "metrics": {
    ...
    "estimatedMarketValue": "$XXX,XXX — from Zillow/Redfin/Realtor search results. NEVER use assessed value here.",
    "estimatedMarketValueRange": "$X-$Y if range available",
    "marketValueConfidence": "High/Medium/Low — based on source quality",
    "marketValueMethod": "Zillow estimate / Redfin estimate / listing history / comparable sales / Not found",
