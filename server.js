...
async function gatherSearchResultsV2(ownerName, streetAddress, city, state) {
  ...
  const isEntity = /LLC|TRUST|LTD|PARTNERSHIP|INC|CORP|ESTATE|FOUNDATION|HOLDINGS|COMPANY|GROUP|RANCH|FARM|PROPERTIES|INVESTMENTS|ASSOCIATES|VENTURES|ENTERPRISES|PARTNERS|DEVELOPMENT|DEVELOPERS|REALTY|MANAGEMENT|RANCH|FARM|PROPERTIES|INVESTMENTS|ASSOCIATES|VENTURES|ENTERPRISES|PARTNERS|DEVELOPMENT|DEVELOPERS|REALTY|MANAGEMENT/i.test(ownerName);
  if (isEntity) {
...
Return ONLY valid JSON:
{
  ...
  "metrics": {
    "estimatedValue": "$XXX,XXX or range",
  ...
  "sellerPsychology": {
    "motivations": "What would realistically trigger a sale for THIS segment/owner",
    "hesitations": "What holds them back — specific to their situation",
    "offMarketPreference": "Why they'd choose discreet sale over MLS, or why they wouldn't",
    "decisionProcess": "Who's involved, how fast, what matters most",
    "triggerEvents": "Specific events that would move them from passive to active"
  },
  "howTheyThink": {
    "financialMindset": "Based on segment, property, career",
    "communication": "Based on generation, profession, entity type",
    "socialPosition": "Based on property, neighborhood, community",
    "bestChannel": "Letter/Phone/Email/Door with segment-specific reasoning"
  },
  "wealthIndicators": {
