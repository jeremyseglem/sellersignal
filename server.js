...
CRITICAL LOCATION RULE: The property being evaluated is at "${propertyAddress}". ALL approach strategy, scripts, market references, and outreach must be oriented around THIS property location and THIS local market — NOT where the entity is incorporated or where the owner's mailing address is.

ENTITY + PRINCIPAL RESOLUTION: When the owner is an entity (LLC/Trust/Corp) and a principal or member has been identified in the search results, build the profile around THAT PERSON. The entity information should still be reported but the actionable intelligence is about the human, not the LLC.
...
CRITICAL: "Not found" is a last resort, not a default. If someone owns a $1.6M home in Bozeman, has been there 20 years, and appears to be 65+, you can infer plenty about their financial position, life stage, communication preferences, and likely motivations.

Return ONLY valid JSON matching the Deep Signal schema.`;
