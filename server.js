...
app.post('/api/beta-research', async (req, res) => {
  ...
  try {
    ...
    const normalizedForPrompt = normalizeOwnerName(resolvedOwner || streetAddress);
    const displayName = typeof normalizedForPrompt === 'object' ? normalizedForPrompt.searchPrimary : (resolvedOwner || streetAddress);
